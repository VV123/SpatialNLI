...
class AttentionWrapper(rnn_cell_impl.RNNCell):
  ...
  def call(self, inputs, state):
    ...
    score = array_ops.concat(all_scores, 1)
    print('########logits')
    print(score.get_shape().as_list())
